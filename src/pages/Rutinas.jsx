...
const Rutinas = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingRutina) {
                await api.put(`/rutinas/${editingRutina.id}/`, data);
            } else {
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {rutinas.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {rutinas.map((rutina) => (
                        <div key={rutina.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                                    ...
                                    <div className="flex gap-2">
                                        <button onClick={() => handleEdit(rutina)} className="text-blue-600 hover:text-blue-800 p-2">
                                            <PencilSquareIcon className="w-5 h-5" />
                                        </button>
                                        <button onClick={() => handleDelete(rutina.id)} className="text-red-600 hover:text-red-800 p-2">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl">
                        <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                            ...
                            <button onClick={handleCloseModal} className="text-gray-600 hover:text-gray-800 p-2">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="duracion" value={formData.duracion} onChange={handleInputChange}
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg" required min="1" />
                                </div>
                                <div>
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                <button type="submit"
                                    ...
                                    {editingRutina ? 'Actualizar' : 'Crear'}
                                </button>
                            </div>
                        </form>
                    </div>
